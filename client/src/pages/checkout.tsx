...
const CheckoutForm = ({ amount, description, type = "tip" }: { amount: number; description: string; type?: string }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: type === "tip" ? "Your tip has been sent!" : "Thank you for your purchase!",
      });
    }
  };
      ...
      <div className="min-h-screen flex items-center justify-center p-6">
        <Card className="w-full max-w-md">
          <CardContent className="pt-6 text-center">
            ...
            <h2 className="text-xl font-semibold mb-2">Setting up payment...</h2>
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-4">
          ...
          <div className="inline-flex items-center space-x-2 mb-4">
            {getPaymentIcon()}
            <h1 className="text-3xl font-bold mixxl-gradient-text">Secure Checkout</h1>
          </div>
          <p className="text-muted-foreground">
