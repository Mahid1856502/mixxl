...
export default function Onboarding() {
    ...
    switch (currentStep) {
      ...
      case 4:
        if (userRole === "artist") {
          ...
          if (isValid) {
            setFormData(prev => ({ ...prev, artist: artistForm.getValues() }));
          }
        } else {
          isValid = await privacyForm.trigger();
          if (isValid) {
            setFormData(prev => ({ ...prev, privacy: privacyForm.getValues() }));
          }
        }
        break;
      case 5:
  ...
  const getStepTitle = () => {
    switch (currentStep) {
      case 1: return "Welcome to Mixxl!";
      case 2: return "Set Up Your Profile";
      case 3: return "Music Preferences";
      case 4: return userRole === "artist" ? "Artist Information" : "Privacy Settings";
      case 5: return userRole === "artist" ? "Privacy Settings" : "Almost Done!";
      case 6: return "Almost Done!";
      default: return "";
    }
  };
  ...
  const getStepDescription = () => {
    switch (currentStep) {
      case 1: return "Let's get you set up for an amazing music experience";
      case 2: return "Tell the community about yourself";
      case 3: return "Help us personalize your experience";
      case 4: return userRole === "artist" ? "Share your artistic journey" : "Choose your privacy preferences";
      case 5: return userRole === "artist" ? "Choose your privacy preferences" : "Review and confirm your choices";
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Connect with incredible artists, discover new music, and build your perfect playlists. 
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <Card className="glass-effect border-white/10">
                  <CardContent className="p-6 text-center">
                    ...
                    <h4 className="text-lg font-semibold mb-2">Join the Community</h4>
                    <p className="text-sm text-muted-foreground">
                      Connect with music lovers, follow your favorite artists, and share your discoveries
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="glass-effect border-white/10">
                  <CardContent className="p-6 text-center">
                    ...
                    <h4 className="text-lg font-semibold mb-2">Discover Music</h4>
                    <p className="text-sm text-muted-foreground">
                      Explore new sounds, hidden gems, and emerging artists from around the world
                    </p>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="text-center">
                <div className="inline-flex items-center space-x-4 p-4 bg-white/5 rounded-lg border border-white/10">
                  ...
                  <span className="text-sm font-medium">Let's set up your personalized music experience</span>
                    ...
                    <FormItem>
                          ...
                          return (
                            <Badge
                              ...
                              onClick={() => {
                                ...
                                preferencesForm.setValue('genres', newValue, { shouldValidate: true, shouldDirty: true });
                                ...
                                console.log('Genre selection changed:', { 
                                  ...
                                  formValueAfter: preferencesForm.getValues().genres
                                });
                              }}
                            >
                              {genre}
                      ...
                      <div className="text-xs text-red-400 mt-1">
                        {formData.preferences?.genres?.length > 0 && (
                          <span>Selected: {formData.preferences.genres.length} genres</span>
                        )}
                      </div>
                      <FormMessage />
                    </FormItem>
                          ...
                          return (
                            <Badge
                              ...
                              onClick={() => {
                                ...
                                // Force update both field and form state
                                field.onChange(newValue);
                                preferencesForm.setValue('listenGoals', newValue, { shouldValidate: true, shouldDirty: true });
                              }}
                            >
                              {goal}
                            </Badge>
          ...
          return (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">Share your artistic journey</p>
              </div>
              {/* Artist form content */}
            </div>
          );
          ...
          return (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">Choose your privacy preferences</p>
              </div>
                      ...
                      render={({ field }) => (
                        <FormItem className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">Support your favorite artists with tips</p>
                          </div>
                        </FormItem>
                      )}
                    />
          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-lg text-muted-foreground">
                You're all set up and ready to dive into the world of independent music
              </p>
            </div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex items-start space-x-3">
                      ...
                      <div>
                        <FormLabel>Subscribe to our newsletter (Optional)</FormLabel>
                        <p className="text-sm text-muted-foreground">
        ...
        <Card className="glass-effect border-white/10">
          <CardContent className="p-8">
            ...
            <div className="flex justify-between pt-8">
              <Button
                variant="outline"
                onClick={currentStep === 1 ? () => setLocation("/setup-role") : prevStep}
